# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-09-25 00:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projectStatus', models.PositiveIntegerField(choices=[(1, 'Submitted'), (2, 'Accepted'), (3, 'Rejected'), (4, 'Cancelled'), (5, 'Waiting list')], default=1, verbose_name='Project state')),
                ('createDate', models.DateField(auto_now_add=True)),
                ('modifyDate', models.DateField(auto_now=True)),
                ('modifyBy', models.TextField(blank=True, verbose_name='Modify by')),
                ...
                ('language', models.PositiveIntegerField(choices=[(1, 'german'), (2, 'english')], default=1, verbose_name='Which language do you want to communicate?')),
                ...
                ('internalComment', models.TextField(blank=True, verbose_name='Internal Comment')),
                ...
                ('logoOrg', models.ImageField(blank=True, upload_to=b'projects/logos', verbose_name='Org logo')),
                ...
                ('boothLocation', models.CharField(blank=True, max_length=10, verbose_name='Location')),
                ...
                ('boothStatus', models.PositiveIntegerField(choices=[(1, 'Submitted'), (2, 'Accepted'), (3, 'Rejected'), (4, 'Booth detailing'), (5, 'Service completed')], default=1, verbose_name='Booth state')),
                ...
                ('boothComment', models.TextField(blank=True, verbose_name='Internal comment:')),
                ('boothLastMinute', models.TextField(blank=True, verbose_name='Here you have the chance to leave us further comments regarding your booth:')),
